...
public class tiny_gp {
     ...
     *
     */
    public static final double PMUT_PER_NODE = 0.02,
            /**
    ...
    void setup_fitness(String fname) {
        ...
        try {
            ...
            if (varnumber + numberconst >= FSET_START)
                System.out.println("too many variables");
            if (fitnesscases >= 1000)
                System.out.println("too many fitness cases");
    ...
    void stats(double[] fitness, char[][] pop, int gen) {
        ...
        favgpop /= POPSIZE;
        System.out.print("Generation=" + gen + " Avg Fitness=" + (-favgpop) + " Best=pop[" + best + "] Fitness="
